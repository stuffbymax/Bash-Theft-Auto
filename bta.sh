...
rob_store() {
  ...
  local damage
  local fine
  local stealth_skill=$((skills["stealth"] * 5)) # Influence success
...
gang_war() {
  ...
  local damage
  local fine
  local strength_skill=$((skills["strength"] * 5)) # Influence success
...
carjack() {
  ...
  local success_chance=$((driving_skill + stealth_skill)) # Combined influence
